...
public class WeatherLoggingHandler implements SOAPHandler<SOAPMessageContext> {
	
    private static final Logger LOG = Logger.getLogger(WeatherLoggingHandler.class);
	...
	public boolean handleFault(SOAPMessageContext context) {
		...
		if (!outboundProperty.booleanValue()) {
	    	createRecordLog(log, "this", "Weather", TypeRecord.REQUEST, CountryEndpoint.getIdSession());
		} else {
	    	createRecordLog(log, "Weather", "this", TypeRecord.RESPONSE, CountryEndpoint.getIdSession());
		}
	...
	private void contextToString(SOAPMessageContext smc, Log log) {
		try {
			...
			LOG.error("Exception in handler Weather. ", e);
		}
