...
@HandlerChain(file="/locations.xml")
public class Locations
    extends Service
{

    private final static URL LOCATIONS_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(ru.gismeteo.ws.Locations.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = ru.gismeteo.ws.Locations.class.getResource(".");
            url = new URL(baseUrl, "http://ws.gismeteo.ru/Locations/Locations.asmx?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://ws.gismeteo.ru/Locations/Locations.asmx?wsdl', retrying as a local file");
    ...
    public Locations() {
        super(LOCATIONS_WSDL_LOCATION, new QName("http://ws.gismeteo.ru/", "Locations"));
    }
